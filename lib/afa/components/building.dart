...
class _MultiplyFormState extends State<Building> {
  ...
  void _updateTotal() {
    ...
    double total1 = double.tryParse(total.text) ?? 0;
    // int a =
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: (widget.type == "Edit")
                        ? widget.l_value.toString()
                        : "l",
